...
def test_generation_resolution_presets_are_sd_friendly():
    assert dimensions_from_generation_preset(568, "4:3") == (568, 424)
    assert dimensions_from_generation_preset(568, "3:4") == (424, 568)
    assert dimensions_from_generation_preset(1024, "1:1") == (1024, 1024)
    wide = dimensions_from_generation_preset(1024, "16:9")
    assert wide == (1024, 576)
    assert all(value % 8 == 0 for value in wide)
