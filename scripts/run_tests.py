...
SUITES: dict[str, tuple[str, ...]] = {
    ...
    "generation": (
        ...
        "test_generation_runner_outputs.py",
        "test_generation_prompts.py",
        "test_image_lab.py",
        "test_image_runtime_pipelines.py",
        "test_image_workflow_service.py",
        "test_mask.py",
        "test_outpaint.py",
        ...
        "test_samplers.py",
        "test_smoke_image_routes.py",
        "test_studio.py",
        "test_studio_generation_packet.py",
        "test_studio_lora_stack.py",
        "test_style_presets.py",
        "test_workflow_code_blocks.py",
    ),
    "models": (
        "test_bnb_nf4_format.py",
    ...
    "services": (
        "test_audio.py",
        "test_audio_lab_runner.py",
        "test_chat_agent_tools.py",
        "test_chat_atlas_rag.py",
        "test_client_log.py",
    ...
    "training": (
        ...
        "test_llm_dataset_builder.py",
        "test_llm_installer.py",
        "test_training_config_builders.py",
        "test_training_engine_status.py",
        "test_training_tab.py",
    ),
    "ui": (
        "test_chat_workspace.py",
        "test_gallery_select.py",
        "test_modern_web_ui.py",
        "test_settings.py",
        "test_studio.py",
        "test_studio_v5_labs.py",
        "test_studio_v5_ui_contracts.py",
        "test_theme.py",
        "test_web_registry.py",
    ),
    "video": (
