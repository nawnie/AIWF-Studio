...
Gradio / routing / config / logs / model browser / phone companion
        ...
        â”‚       image generation / Wan / LTX / VAE decode / RIFE / NVENC
        â”‚       separate generation venv
        â”‚
        â”œâ”€â”€ Ollama Chat Tenant
        â”‚       external local service via HTTP API
        â”‚
        â”œâ”€â”€ Kohya LoRA Engine
        â”‚       separate training venv
        â”‚
        â””â”€â”€ ED2 Full-Training Engine
...
```text
Main UI venv
    â†“ user clicks Video tab
Reload into video Gradio app from video venv
    â†“ user clicks Training tab
...
```text
AIWF_Studio/
â”œâ”€â”€ launch_aiwf.ps1
â”œâ”€â”€ README.md
â”œâ”€â”€ docs/
â”‚   â”œâ”€â”€ architecture/
â”‚   â”‚   â””â”€â”€ engine_isolation_architecture.md
â”‚   â””â”€â”€ permissions/
â”‚       â”œâ”€â”€ everydream2_permission_note.md
â”‚       â””â”€â”€ screenshots/
â”‚           â””â”€â”€ ed2_fork_permission_discord.png
â”‚
â”œâ”€â”€ app/
â”‚   â”œâ”€â”€ webui.py
â”‚   â”œâ”€â”€ ui/
â”‚   â”‚   â”œâ”€â”€ image_tab.py
â”‚   â”‚   â”œâ”€â”€ video_tab.py
â”‚   â”‚   â”œâ”€â”€ chat_tab.py
â”‚   â”‚   â”œâ”€â”€ training_tab.py
â”‚   â”‚   â””â”€â”€ settings_tab.py
â”‚   â”‚
â”‚   â”œâ”€â”€ services/
â”‚   â”‚   â”œâ”€â”€ gpu_tenant_lock.py
â”‚   â”‚   â”œâ”€â”€ engine_supervisor.py
â”‚   â”‚   â”œâ”€â”€ generation_client.py
â”‚   â”‚   â”œâ”€â”€ kohya_client.py
â”‚   â”‚   â”œâ”€â”€ ed2_client.py
â”‚   â”‚   â””â”€â”€ ollama_client.py
â”‚   â”‚
â”‚   â”œâ”€â”€ domain/
â”‚   â”‚   â”œâ”€â”€ generation_requests.py
â”‚   â”‚   â”œâ”€â”€ training_requests.py
â”‚   â”‚   â”œâ”€â”€ engine_events.py
â”‚   â”‚   â”œâ”€â”€ job_status.py
â”‚   â”‚   â””â”€â”€ paths.py
â”‚   â”‚
â”‚   â””â”€â”€ utils/
â”‚       â”œâ”€â”€ log_tail.py
â”‚       â”œâ”€â”€ process_tree.py
â”‚       â””â”€â”€ path_safety.py
â”‚
â”œâ”€â”€ engines/
â”‚   â”œâ”€â”€ generation/
â”‚   â”‚   â”œâ”€â”€ .venv/
...
â”‚   â”‚   â””â”€â”€ engine_config.example.toml
â”‚   â”‚
â”‚   â”œâ”€â”€ kohya/
â”‚   â”‚   â”œâ”€â”€ .venv/
â”‚   â”‚   â”œâ”€â”€ kohya_ss/
...
â”‚   â””â”€â”€ ed2/
â”‚       â”œâ”€â”€ .venv/
â”‚       â”œâ”€â”€ EveryDream2trainer/
â”‚       â”œâ”€â”€ worker.py
â”‚       â”œâ”€â”€ requirements.txt
â”‚       â””â”€â”€ engine_config.example.toml
â”‚
â”œâ”€â”€ models/
...
â”‚
â””â”€â”€ configs/
    â”œâ”€â”€ aiwf_studio.toml
    â”œâ”€â”€ engines.toml
    â””â”€â”€ gpu_policy.toml
```
...
â”œâ”€â”€ request.json
â”œâ”€â”€ resolved_config.toml
â”œâ”€â”€ stdout.jsonl
â”œâ”€â”€ stderr.log
â”œâ”€â”€ status.json
â””â”€â”€ artifacts/
    â”œâ”€â”€ output.mp4
    â”œâ”€â”€ output.safetensors
...
```text
Training Tab
â”œâ”€â”€ Dataset Preflight
â”‚   â”œâ”€â”€ image count
â”‚   â”œâ”€â”€ caption pairing
â”‚   â”œâ”€â”€ repeats_concept folder validation
â”‚   â”œâ”€â”€ resolution/bucket sanity checks
â”‚   â””â”€â”€ optional VLM auto-captioning
â”‚
â”œâ”€â”€ Simple LoRA Training
â”‚   â””â”€â”€ Kohya backend
â”‚
â”œâ”€â”€ Advanced LoRA Training
â”‚   â””â”€â”€ Kohya backend with expanded parameters
â”‚
â””â”€â”€ Full Model Training
    â””â”€â”€ ED2-compatible backend
```
...
### Phase 1 â€” Lock the architecture boundary
...
### Phase 2 â€” Generation engine worker
...
### Phase 5 â€” ED2 full-training engine
...
### Phase 6 â€” Phone companion support
...
- [ ] Add user-facing explanation: â€œone app, isolated engines.â€
...
This preserves the â€œone programâ€ experience while avoiding the dependency-conflict model that makes normal users deal with broken environments and unreadable traces.
