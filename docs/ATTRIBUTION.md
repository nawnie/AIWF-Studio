...
- Supports text-prompt → box → mask workflows (Grounding DINO-tiny via Hugging Face `transformers` in our build)
...
- [Grounding DINO](https://github.com/IDEA-Research/GroundingDINO) — text-to-box detection in the original extension


## ControlNet integration

ControlNet conditioning in Aiwf is a clean-room reimplementation. The preprocessor
vocabulary (canny, depth, openpose, lineart, scribble, …) follows the familiar
