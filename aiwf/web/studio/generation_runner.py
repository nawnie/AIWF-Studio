...
class GenerationRunner:
    ...
    def run_once(self, mode_label: str, all_inputs: tuple, *, keep_continuous_toggle: bool) -> Iterator[tuple]:
        request, init_images, mask_images, before_image, mode, control_images = build_generation_request(
            ...
            img2img_denoise=all_inputs[20],
            inpaint_denoise_value=all_inputs[21],
            mask_blur_value=all_inputs[22],
            inpaint_area_value=all_inputs[23],
            inpaint_padding_value=all_inputs[24],
            masked_content_value=all_inputs[25],
            source_image=all_inputs[26],
            editor_value=all_inputs[27],
            ckpt_map=all_inputs[28],
            tags_text=all_inputs[29],
            use_file=all_inputs[30],
            prompt_file_path=all_inputs[31],
            dynamic_seed=all_inputs[32],
            style_name=all_inputs[33],
            style_template_prompt=all_inputs[34],
            style_template_negative=all_inputs[35],
            cn_enable=all_inputs[36],
            cn_model_id=all_inputs[37],
            cn_module=all_inputs[38],
            cn_image=all_inputs[39],
            cn_weight=all_inputs[40],
            cn_guidance_start=all_inputs[41],
            cn_guidance_end=all_inputs[42],
            cn_threshold_a=all_inputs[43],
            cn_threshold_b=all_inputs[44],
            cn2_enable=all_inputs[45],
            cn2_model_id=all_inputs[46],
            cn2_module=all_inputs[47],
            cn2_image=all_inputs[48],
            cn2_weight=all_inputs[49],
            cn2_guidance_start=all_inputs[50],
            cn2_guidance_end=all_inputs[51],
            cn2_threshold_a=all_inputs[52],
            cn2_threshold_b=all_inputs[53],
            cn3_enable=all_inputs[54],
            cn3_model_id=all_inputs[55],
            cn3_module=all_inputs[56],
            cn3_image=all_inputs[57],
            cn3_weight=all_inputs[58],
            cn3_guidance_start=all_inputs[59],
            cn3_guidance_end=all_inputs[60],
            cn3_threshold_a=all_inputs[61],
            cn3_threshold_b=all_inputs[62],
            inpaint_source_choice=all_inputs[63],
