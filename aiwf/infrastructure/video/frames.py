...
def process_video_file(
    ...
    *,
    ...
    # cv2 writes mp4v (MPEG-4 Part 2), which browsers/gradio cannot play.
    # Transcode every saved clip to H.264 so it previews and loads everywhere.
    from aiwf.infrastructure.video.processing import _transcode_to_h264

    _transcode_to_h264(dest)
